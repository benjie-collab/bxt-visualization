...
/********************************
* Select Viz Type Form: bxtviz_select_chart_type
********************************/

add_action("wp_ajax_nopriv_bxtviz_select_chart_type", "bxtviz_select_charttype");
add_action('wp_ajax_bxtviz_select_chart_type', 'bxtviz_select_charttype');

function bxtviz_select_charttype(){
